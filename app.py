...
def do_query(params):
    ...
    if 'cmd1' in params.keys():
        res = do_command(params['cmd1'], params['value1'], res)
    if 'cmd2' in params.keys():
        res = do_command(params['cmd2'], params['value2'], res)
    if 'cmd3' in params.keys():
        res = do_command(params['cmd3'], params['value3'], res)
    return res
